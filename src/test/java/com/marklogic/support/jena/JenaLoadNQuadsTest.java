...
class JenaLoadNQuadsTest {
    ...
    void testLoadingSampleFive() {
        assertTimeoutPreemptively(ofSeconds(130), () -> RDFDataMgr.read(MarkLogicJenaExtension.DSG, "src/main/resources/nquads/5_63578.nq", Lang.NQUADS));
    ...
    void testLoadingSampleSix() {
        assertTimeoutPreemptively(ofSeconds(250), () -> RDFDataMgr.read(MarkLogicJenaExtension.DSG, "src/main/resources/nquads/6_125268.nq", Lang.NQUADS));
