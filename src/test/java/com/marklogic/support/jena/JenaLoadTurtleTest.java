...
class JenaLoadTurtleTest {
    ...
    @Benchmark
    @RepeatedTest(2)
    @DisplayName("Using the Jena Client API to load an 801Kb turtle file (IVOAT.ttl)")
    void testLoadingSmallTurtleSampleWithJena() {
        assertTimeoutPreemptively(ofSeconds(10), () -> RDFDataMgr.read(MarkLogicJenaExtension.DSG.getDefaultGraph(), "src/main/resources/turtle/IVOAT.ttl", Lang.TURTLE));
        assertEquals(26286, SPARQLUtils.countAllTriples(MarkLogicJenaExtension.DSG));
        assertEquals(26286, MarkLogicReSTApiClientProvider.getTripleCount());
    ...
    void testLoadingSmallXTurtleFile() {
        assertTimeoutPreemptively(ofSeconds(10), () -> RDFDataMgr.read(MarkLogicJenaExtension.DSG.getDefaultGraph(), "src/main/resources/turtle/charging-stations-export-20170530-095533.ttl", Lang.TURTLE));
    ...
    void testLoadingSmallTurtleFile() {
        assertTimeoutPreemptively(ofSeconds(18), () -> RDFDataMgr.read(MarkLogicJenaExtension.DSG.getDefaultGraph(), "src/main/resources/turtle/units.ttl", Lang.TURTLE));
    ...
    void testLoadingMediumSizeTurtleFile() {
        assertTimeoutPreemptively(ofSeconds(60), () -> RDFDataMgr.read(MarkLogicJenaExtension.DSG.getDefaultGraph(), "src/main/resources/turtle/unescothes.ttl", Lang.TURTLE));
    ...
    void testLoadingLargeTurtleFile() {
        assertTimeoutPreemptively(ofSeconds(330), () -> RDFDataMgr.read(MarkLogicJenaExtension.DSG.getDefaultGraph(), "src/main/resources/turtle/history.ttl", Lang.TURTLE));
    ...
    void testLoadingAnotherLargeTurtleFile() {
        assertTimeoutPreemptively(ofSeconds(1000), () -> RDFDataMgr.read(MarkLogicJenaExtension.DSG.getDefaultGraph(), "src/main/resources/turtle/fulldump.ttl", Lang.TURTLE));
