...
class XQueryLoadTriGTest {
    ...
    void testLoadingSmallTriGFile() {
        Response res = assertTimeoutPreemptively(ofSeconds(10), () -> MarkLogicReSTApiClientProvider.evalXQuery(createXQuerySemLoad("trig/charging-stations-export-20170530-095530.trig", "trig")));
    ...
    void testLoadingAnotherSmallTriGFile() {
        Response res = assertTimeoutPreemptively(ofSeconds(20), () -> MarkLogicReSTApiClientProvider.evalXQuery(createXQuerySemLoad("trig/example.trig", "trig")));
        assertEquals("OK", res.message());
        assertEquals(200, res.code());
    ...
    void testLoadingLargeTriGFile() {
        Response res = assertTimeoutPreemptively(ofSeconds(400), () -> MarkLogicReSTApiClientProvider.evalXQuery(createXQuerySemLoad("trig/wp-monthy_all.trig", "trig")));
        assertEquals("OK", res.message());
        assertEquals(200, res.code());
