...
class XQueryLoadRDFXMLTest {
    ...
    void testLoadingSmallRDFXMLFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(5), () -> MarkLogicReSTApiClientProvider.evalXQuery(createXQuerySemLoad("rdfxml/capitals.rdf", "rdfxml")));
    ...
    void testLoadingAnotherSmallRDFXMLFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(5), () -> MarkLogicReSTApiClientProvider.evalXQuery(createXQuerySemLoad("rdfxml/currencies.rdf", "rdfxml")));
        assertEquals("OK", res.getClientResponseStatus().getReasonPhrase());
        assertEquals(200, res.getStatus());
    ...
    void testLoadingYetAnotherSmallRDFXMLFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(5), () -> MarkLogicReSTApiClientProvider.evalXQuery(createXQuerySemLoad("rdfxml/countries.rdf", "rdfxml")));
        assertEquals("OK", res.getClientResponseStatus().getReasonPhrase());
        assertEquals(200, res.getStatus());
    ...
    void testLoadingMediumRDFXMLFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(45), () -> MarkLogicReSTApiClientProvider.evalXQuery(createXQuerySemLoad("rdfxml/peel.rdf", "rdfxml")));
        assertEquals("OK", res.getClientResponseStatus().getReasonPhrase());
        assertEquals(200, res.getStatus());
