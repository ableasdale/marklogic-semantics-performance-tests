...
class ReSTLoadTriGTest {
    ...
    void testLoadingSmallTriGFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(5), () -> MarkLogicReSTApiClientProvider.createPostForTrig("trig/charging-stations-export-20170530-095530.trig"));
    ...
    void testLoadingAnotherSmallTriGFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(20), () -> MarkLogicReSTApiClientProvider.createPostForTrig("trig/example.trig"));
        assertEquals(201, res.getStatus());
    ...
    void testLoadingLargeTriGFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(150), () -> MarkLogicReSTApiClientProvider.createPostForTrig("trig/wp-monthy_all.trig"));
        assertEquals(201, res.getStatus());
