...
class ReSTLoadNTriplesTest {
    ...
    void testLoadingSmallNtFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(5), () -> MarkLogicReSTApiClientProvider.createPostForNTriples("nt/ron.nt"));
    ...
    void testLoadingAnotherSmallNtFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(5), () -> MarkLogicReSTApiClientProvider.createPostForNTriples("nt/rmn.nt"));
        assertEquals("Created", res.getClientResponseStatus().getReasonPhrase());
        assertEquals(201, res.getStatus()); // returns 201 because it returns content in the response body
    ...
    void testLoadingMediumNtFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(40), () -> MarkLogicReSTApiClientProvider.createPostForNTriples("nt/dbpedia60k.nt"));
        assertEquals("Created", res.getClientResponseStatus().getReasonPhrase());
        assertEquals(201, res.getStatus()); // returns 201 because it returns content in the response body
    ...
    void testLoadingMedNtFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(60), () -> MarkLogicReSTApiClientProvider.createPostForNTriples("nt/ron-data.nt"));
        assertEquals("Created", res.getClientResponseStatus().getReasonPhrase());
        assertEquals(201, res.getStatus()); // returns 201 because it returns content in the response body
    ...
    void testLoadingAnotherMedNtFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(60), () -> MarkLogicReSTApiClientProvider.createPostForNTriples("nt/rmn-data.nt"));
        assertEquals("Created", res.getClientResponseStatus().getReasonPhrase());
        assertEquals(201, res.getStatus()); // returns 201 because it returns content in the response body
    ...
    void testLoadingLargeNtFile() {
        ClientResponse res = assertTimeoutPreemptively(ofSeconds(90), () -> MarkLogicReSTApiClientProvider.createPostForNTriples("nt/2013-02-14-panlex-dump.nt"));
        assertEquals("Created", res.getClientResponseStatus().getReasonPhrase());
        assertEquals(201, res.getStatus()); // returns 201 because it returns content in the response body
